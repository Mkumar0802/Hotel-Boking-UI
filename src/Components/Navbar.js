...
function Navbar() {
    ...
    return (
        <div className='text-white  '>
            ...
            <div className=' shadow-md w-full   top-0 left-0 bg-blue-800  p-12'>
            ...
            <div className='bg-blue-800 flex justify-evenly  duration-150 py-9 ' >
                <ul className={` animate-fadeInRightBig md:flex gap-3 md:items-center md:pb-0 pb-12 absolute md:static  md:z-auto z-[-1] left-0 w-3/4 md:w-auto md:pl-0 pl-9 transition-all duration-500 ease-in ${open ? '  top-20 ' : 'top-[-490px]  '}`}>
                    <li className="  rounded-full px-4 py-2  bg-blue-700  hover:bg-blue-700   flex  text-justify hover:ring-4 ring-white transition ease-in-out duration-100"> Stays</li>
                    <li className=" rounded-full px-4 py-2  bg-blue-700  hover:bg-blue-700    flex  text-justify hover:ring-4 ring-white transition ease-in-out duration-100"> Fight</li>
                    <li className=" rounded-full px-4 py-2  bg-blue-700  hover:bg-blue-700    flex  text-justify hover:ring-4 ring-white transition ease-in-out duration-100"> Fight + Hotel</li>
                    <li className=" rounded-full px-4 py-2  bg-blue-700  hover:bg-blue-700    flex  text-justify hover:ring-4 ring-white transition ease-in-out duration-100"> Car rentals</li>
                    <li className=" rounded-full px-4 py-2  bg-blue-700  hover:bg-blue-700    flex  text-justify hover:ring-4 ring-white transition ease-in-out duration-100"> Airport taxis</li>
